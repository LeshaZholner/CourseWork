...
namespace WebApp.Admin.Controllers
{
    ...
    public class DoctorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,SpecializationId,FirstName,SecondName,PhoneNumber")] Doctor doctor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,SpecializationId,FirstName,SecondName,PhoneNumber")] Doctor doctor)
        {
            if (ModelState.IsValid)
            {
